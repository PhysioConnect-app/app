...
#
# Prerequisites:
#   1. GitHub account "PhysioConnect-app" - done
#   2. Repo "app" under that account, public, no README - done
...
Write-Host ""
Write-Host "Live in ~60 seconds at:" -ForegroundColor Cyan
Write-Host "  https://physioconnect-app.github.io/app/" -ForegroundColor White
Write-Host ""
Write-Host "One-time steps if not done yet:" -ForegroundColor Yellow
Write-Host "  * GitHub: PhysioConnect-app/app -> Settings -> Pages -> Branch: gh-pages / root"
Write-Host "  * Supabase: already configured via API"
Write-Host ""
